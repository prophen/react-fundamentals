...
All the code before the final extra credit
...
```JavaScript
    ...
    const PropTypes = {
      string(props, propName, componentName) {
        ...
        if (type !== 'string') {
          return new Error(
            `Hey, the component ${componentName} needs the prop ${propName} to be a type of "string" but was passed a number`,
          )
        }
      },
    }
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=04%3A%20Creating%20custom%20components&em=nprophet%40paypal.comnprophet%40paypal.com).
